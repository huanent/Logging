...
{
    public partial class SqliteLogger : ILogger
    {
        private readonly SqliteLoggerWriter _fileLoggerWriter;
        private readonly Func<string, LogLevel, bool> _filter;
        private readonly string _name;

        public SqliteLogger(string name, SqliteLoggerWriter fileLoggerWriter)
        {
            _name = string.IsNullOrEmpty(name) ? nameof(SqliteLogger) : name;
